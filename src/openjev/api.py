...
from .schema import Evaluation, Result
from .service import Evaluator


class Guard:
    """Bound streamed bodies before JSON parsing and authenticate private routes."""
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    @app.post("/v1/systemone", response_model=Result, tags=["SystemOne"], summary="Evaluate state")
